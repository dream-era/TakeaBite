  ...
  return (
    <>
      ...
      <div style={{ padding: '24px 32px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        {/* ── SALES CHART + HIGH DEMAND PRODUCTS ── */}
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
            {[
              ...
              { icon: '🔲', label: 'Generate QR', sub: 'Share your menu', href: '/qr-tables', color: '#0891b2' },
              { icon: '👤', label: 'Manage Staff', sub: 'Add or edit staff', href: '/staff-workspace', color: '#7c3aed' },
